            ...
            <Page size="A4" style={styles.pageContainer}>
                ...
                <View style={styles.main}>
                    ...
                    <View style={styles.billingInfo}>
                        ...
                        <Text style={styles.infoField}>Prozentsatz: {toGermanString(billing.percentage) + ' %'}</Text>
...
const styles = StyleSheet.create({
    ...
    logoContainer: { display: 'flex', flexDirection: 'row-reverse' },
    logo: { height: '90pt', width: '120pt' },
    ...
    footer: { position: 'absolute', left: 0, bottom: 0, width: '100vw', padding: '40pt 60pt' },
